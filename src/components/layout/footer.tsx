...
/**
 * Composant représentant le pied de page global du site.
 *
 * cette page contient :
 * - le logo et une courte description
 * - des liens de navigation vers les pages principales
 * - les informations de contact
 * - les liens vers les réseaux sociaux
 * - les informations de copyright
 *
 * @returns {JSX.Element} Pied de page complet du site LT Coaching.
 *
 */
